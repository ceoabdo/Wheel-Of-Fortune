...
{
    public sealed class SilverZoneStrategy : IZoneTypeStrategy
    {
        private readonly WheelProgressionProfile _profile;
        private readonly ZoneVisualConfig _visualConfig;
        
        public SilverZoneStrategy(WheelProgressionProfile profile, ZoneVisualConfig visualConfig)
        {
            _profile = profile;
