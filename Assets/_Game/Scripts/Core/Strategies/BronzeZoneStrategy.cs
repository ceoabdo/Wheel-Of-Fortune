...
{
    public sealed class BronzeZoneStrategy : IZoneTypeStrategy
    {
        private readonly WheelProgressionProfile _profile;
        private readonly ZoneVisualConfig _visualConfig;

        public BronzeZoneStrategy(WheelProgressionProfile profile, ZoneVisualConfig visualConfig)
        {
            _profile = profile;
